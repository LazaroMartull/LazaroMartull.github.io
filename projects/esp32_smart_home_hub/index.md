...
The system collects live sensor data, applies automation logic locally and in the cloud, and allows manual control through an interactive interface.
...
- Secure MQTT communication with AWS IoT Core using TLS and certificates
